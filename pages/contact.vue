	...
	<main class="overflow-hidden">
		...
		<div class="bg-warm-gray-50">
			<div class="py-20">
				<div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
					<h1 class="text-4xl font-extrabold tracking-tight text-warm-gray-900 sm:text-5xl lg:text-6xl">Contactez-nous</h1>
					<p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">
						Nous sommes ouverts au public du lundi au vendredi de 8h à 20h. N'hésitez pas à contacter notre équipe via ce formulaire pour toute question.
					</p>
				</div>
			</div>
		</div>
		...
		<section class="relative bg-white" aria-labelledby="contactHeading">
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="relative bg-white shadow-xl">
					<h2 id="contactHeading" class="sr-only">Contactez-nous</h2>

					<div class="grid grid-cols-1 lg:grid-cols-3">
						<!-- Contact information -->
						<div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-gray-900 to-base-red-darken-3 sm:px-10 xl:p-12">
							...
							<dl class="mt-8 space-y-6">
								...
								<dd class="flex text-base text-teal-50">
									<svg class="flex-shrink-0 w-6 h-6 text-base-yellow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
									</svg>
									<span class="ml-3">contact@gameher.fr</span>
								</dd>

								<dt><span class="sr-only">Partners</span></dt>
								<dd class="flex text-base text-teal-50">
									<svg class="flex-shrink-0 w-6 h-6 text-base-yellow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
									</svg>
									<span class="ml-3">partenariat@gameher.fr</span>
								</dd>

								<dt><span class="sr-only">Phone number</span></dt>
								<dd class="flex text-base text-teal-50">
									<svg class="flex-shrink-0 w-6 h-6 text-base-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg>
									<span class="ml-3">esport@gameher.fr</span>
								</dd>

								<dt><span class="sr-only">Recrutement email</span></dt>
								<dd class="flex text-base text-teal-50">
									<svg class="flex-shrink-0 w-6 h-6 text-base-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
									<span class="ml-3">recrutement@gameher.fr</span>
								</dd>
							</dl>
							<ul class="mt-10 flex space-x-8" role="list">
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="https://twitter.com/GameHer" target="_blank" rel="nofollow noopener noreferrer">
								...
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="https://www.facebook.com/GameHer" target="_blank" rel="nofollow noopener noreferrer">
								...
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="#">
										<span class="sr-only">Youtube</span>
										<svg class="h-7 w-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path></svg>
									</a>
								</li>
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="#">
										<span class="sr-only">Twitch</span>
										<svg class="h-7 w-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitch" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
								...
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="#">
										...
										<svg class="h-7 w-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
								...
								<li>
									<a class="text-base-yellow hover:text-teal-100" href="#">
										...
										<svg class="h-7 w-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
							...
							<form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
								...
								<div>
									<div class="flex justify-between">
										<label for="phone" class="block text-sm font-medium text-warm-gray-900">Votre téléphone</label>
								...
								<div class="sm:col-span-2">
									<div class="flex justify-between">
										<label for="message" class="block text-sm font-medium text-warm-gray-900">La raison pour laquelle vous nous contactez</label>
								...
								<div class="sm:col-span-2 sm:flex sm:justify-end">
									<button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-base-red-darken-3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-base-yellow sm:w-auto">
										Contactez-nous
									</button>
								</div>
							</form>
		...
		<section aria-labelledby="officesHeading">
			<div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
				<h2 id="officesHeading" class="text-3xl font-extrabold text-warm-gray-900">Nous trouver</h2>
				...
				<div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
					<div>
						<h3 class="text-lg font-medium text-warm-gray-900">Nantes</h3>
						<p class="mt-2 text-base text-warm-gray-500">
							<span class="block">1 place George Washington</span>

							<span class="block">44300, Nantes</span>
						</p>
					</div>
